    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('api_user_id', models.CharField(default='user_edcebdb2-df17-4360-b29d-c614f8a6e7cc', editable=False, primary_key=True, serialize=False, unique=True)),
                ('username', models.CharField(max_length=100, unique=True, verbose_name='username')),
                ('email', models.EmailField(max_length=254, unique=True, verbose_name='email address')),
                ('guild_role', models.CharField(choices=[('GUILD_LEADER', 'Leader'), ('GUILD_OFFICER', 'Officer'), ('GUILD_REID_LEADER', 'Raid Leader'), ('GUILD_RAIDER', 'Raider'), ('GUILD_MEMBER', 'Member')], max_length=100)),
                ('client_id', models.CharField(max_length=100, unique=True)),
                ('client_token', models.CharField(max_length=100)),
                ('characters', models.ManyToManyField(related_name='custom_user_characters', to='character.charactermodel')),
